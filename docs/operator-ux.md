...
| `control`               | Good (post-#44)  | —          | Closed by `reorderFlagsFirst` helper + positional-auto-binds-to-`--to`. Operator's natural typing `claude-msg control alice --command compact` works as expected.                                                                          |
